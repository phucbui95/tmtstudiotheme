...
*/
	...
	function custom_post_type() {
	    ...
	    $labels = array(
	        'name'                => _x( 'People', 'Post Type General Name', 'twentythirteen' ),
	        'singular_name'       => _x( 'People', 'Post Type Singular Name', 'twentythirteen' ),
	        'menu_name'           => __( 'People', 'twentythirteen' ),
	        'parent_item_colon'   => __( 'Parent People', 'twentythirteen' ),
	        'all_items'           => __( 'All People', 'twentythirteen' ),
	        'view_item'           => __( 'View People', 'twentythirteen' ),
	        'add_new_item'        => __( 'Add New People', 'twentythirteen' ),
	        'add_new'             => __( 'Add New', 'twentythirteen' ),
	        'edit_item'           => __( 'Edit People', 'twentythirteen' ),
	        'update_item'         => __( 'Update People', 'twentythirteen' ),
	        'search_items'        => __( 'Search People', 'twentythirteen' ),
    ...
    $args = array(
        'label'               => __( 'people', 'twentythirteen' ),
        'description'         => __( 'People news and reviews', 'twentythirteen' ),
        'labels'              => $labels,
